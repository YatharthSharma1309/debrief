...
import { welcomeHeading } from '../utils/display'
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-4 py-6 sm:px-6 sm:py-8">
        <div className="flex flex-wrap items-start justify-between gap-4 sm:items-end">
          <div className="min-w-0 max-w-2xl">
            ...
            <p className="mt-2 text-sm text-text-muted leading-relaxed sm:text-base">
        ...
        <div className="mt-4 flex flex-wrap gap-1.5">
          {recovers.map((label) => (
            <span
              key={label}
              className="rounded-md border border-border bg-surface-muted px-2 py-1 text-[11px] text-text-muted"
            >
              {label}
            </span>
          ))}
        ...
        <section className="mt-6 pb-8 sm:mt-8 sm:pb-10">
